# this file was generated in a rails/Ruby project (cucumber-0.7.2) and copied here;
...
Given /^(?:|I )am on (.+)$/ do |page_name|
  visit NavigationHelpers::BASE_URL + path_to(page_name)
end
...
Then /^(?:|I )should not see "([^\"]*)"$/ do |text|
  if response_body.respond_to? :should_not
